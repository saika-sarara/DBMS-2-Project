-- =========================================================
-- V31: Fix ambiguous course_id in curriculum replacement
--
-- The RETURNS TABLE output named course_id is a PL/pgSQL variable.
-- Qualify table columns in DELETE predicates so PostgreSQL does not
-- confuse that output variable with modules.course_id / lessons.course_id.
-- =========================================================
...
BEGIN
    ...
    -- Qualifying these columns avoids collision with the output variable.
    DELETE FROM public.modules m WHERE m.course_id = p_course_id;
    DELETE FROM public.lessons l
    WHERE l.course_id = p_course_id AND l.module_id IS NULL;
    ...
    LOOP
        ...
        LOOP
            ...
            INSERT INTO public.lessons (
                course_id, module_id, title, sequence_order,
